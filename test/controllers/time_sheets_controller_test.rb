...
class TimeSheetsControllerTest < ActionController::TestCase
  ...
  test "should create time_sheet" do
    assert_difference('TimeSheet.count') do
      post :create, time_sheet: { end_date: @time_sheet.end_date, start_date: @time_sheet.start_date, user_id: @time_sheet.user_id }
    end
  ...
  test "should update time_sheet" do
    patch :update, id: @time_sheet, time_sheet: { end_date: @time_sheet.end_date, start_date: @time_sheet.start_date, user_id: @time_sheet.user_id }
    assert_redirected_to time_sheet_path(assigns(:time_sheet))
  end
